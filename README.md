...
**Note:** the computer model for this project and the given assembly language are **imaginary** and made by the university.
...
1. An **optional** preceding *label*. for example `PLACE1: `.
...
3. Operands according to the type of the *directive*.
   ...
   for example `LABEL1: .data      +7, -56, 4, 9`.
